...
const DEFAULT_VALUE = "--";
//document đại diện cho DOM
//querySelector là 1 phương thức của DOM cho phép chọn và trả về phần tử HTML đầu tiên phù hợp
...
// sự kiện khi ng dùng click enter để lấy dữ liệu
